...
python3 $DIR/estimate_trends_from_time_series.py --start_year '2004' --end_year '2019' --start_month '1' --end_month '1' --input '/cnrm/vegeo/SAT/CODES_suman/From_Suman/clean_trends/output_test_timeseries' --output './output_tendencies' --product_tag 'lai' --xlim1 '0' --xlim2 '800' --ylim1 '1500' --ylim2 '3500' --master_chunk '500' --choice 'LAI' -l info 1>>$LOGFILE 2>>$LOGFILE
